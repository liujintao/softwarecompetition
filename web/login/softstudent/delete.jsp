...
stmt.executeUpdate("update team set put='N',articlename=null where teamid="+teamid+";");
out.println("<center><font size=2 color=blue>正在处理信息，请稍后........</font></center><meta http-equiv='refresh' content='2;url=1index.jsp '>");
%>