...
<jsp:useBean id="userinfo2" class="com.ytu.xiao.SoftStudent" scope="page">
...
-->
    ...
    <body>
        ...
        if(conn.checkPassword(oldpassword, softid, "softstudent")==1){
        %>
        <% userinfo2.setAccount(((User)session.getAttribute("user")).getAccount());
        conn.modify(userinfo2);%>
    <div>
