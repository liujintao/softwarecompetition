<%@page contentType="text/html" pageEncoding="UTF-8" import="com.ytu.xiao.Teacher"%>
...
<div class="main-cont">
 <form action="modifysuccess.jsp" method="post" name="form1" onsubmit="return send()">
   <div class="cont-info-rember">
    <div class="hd"><strong  class="Cred" style="font-size:14px;">修改您的的个人信息：</strong></div>
    <div class="finish-area">
        ...
        <table border="0" cellspacing="0" cellpadding="0">
          <tbody>
            ...
            <tr>
              <th>新密码：</th>
              <td><input class="ipt-normal" name="info" type="password"/><DIV class=info-pop >
            ...
            <tr>
              <th>个人简介：</th>
              <td height="auto"><textarea class="ipt-normal"  name="info" onBlur="testinfo()"></textarea></td>
            </tr>
          </tbody>
        </table>
