...
<jsp:useBean id="userinfo1" class="com.ytu.xiao.EnglishStudent" scope="request">
      ...
      <div class="finish-area">
        <table border="0" cellspacing="0" cellpadding="0">
          <tbody>
            ...
            <tr>
              <th>是否参加暑期训练营：</th>
              <td><select  name="train" style="width:100px;">
            ...
            <tr>
              <th>是否参加巡回报告会：</th>
              <td><select  style="width:100px" name="meeting">
                  <option style="color:#000000"  value="0"> 请选择</option>
                  <option   style="color:#000000"  value="Y"> 是</option>
                  <option  style="color:#000000" value="N"> 否</option>
                </select></td>
