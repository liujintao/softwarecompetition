...
<%@ page language="java" contentType="text/html; charset=gb2312" import="java.sql.*" import="com.wei.app1.*,java.util.*"%>
...
<map name="Map" id="Map">
  ...
  <area shape="rect" coords="151,3,245,41" href="college.html" target="_parent"/>
...
<div class="cont-info-rember">
    <div class="hd"><strong style="font-size:14px; color:#0099ff;"><center>本次大赛的参赛命题</center></strong></div>
  </div>
<div class="finish-area">
<table width="100%"  border="0" cellspacing="0">
<tr>
        <TD style="font-weight:bold">命题名</TD>
        <td style="font-weight:bold">评分细则及要求</td>
                <td style="font-weight:bold">下载细则</td>
