...
<div id="wrapper">
  ...
  <DIV class="content">
    <DIV class=mcont>
      ...
      <DIV class="main-cont">
        <DIV class=cont-info>
          <H1><img src="../images/ico_right.gif"/>您操作成功！</H1>
          <DIV class=cont-info-det>本页面将在<b><span  style="color:#FF0000"id=yu>3</span><a href=javascript:countDown></a></a></b>秒后自动返回您所编辑的新闻页面，您可以选择以下操作：</DIV>
            ...
            <DIV class=finish-area>
              <TABLE border=0 cellSpacing=0 cellPadding=0>
                <TBODY>
                  ...
                  <TR>
                    <TH><a href="../news.jsp?id=<%=newsid%>">发布的新闻&gt;&gt;</a></TH>
