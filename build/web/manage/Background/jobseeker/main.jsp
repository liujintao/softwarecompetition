...
<table align=center border=0 cellpadding=6 cellspacing=1 width=100% >
  <tbody>
    <tr>
      <td  colspan=3><a href="addnews.jsp">添加新闻</a> &nbsp;&nbsp;<a href="javascript:this.location.reload()">刷新</a> 
    </tr>
    <tr>
      <td  colspan=2 class="td1">&nbsp;</td>
      <td width="167" align=center class="td1" ><%
                DispNews dispnews = new DispNews();
        dispnews.setClassn("job");
        int newscount = dispnews.newsNum();%>
        <b>共有<font color="red"><%=newscount%></font>篇文章 </b></td>
    </tr>
    <%
        int perPage = 4;
        int intPageCount = 0;
    ...
    <tr>
      <td class="td1" ><%=j + 1%></td>
      <td  class="td1" ><a href="editnews.jsp?id=<%=newsinfo.getID()%>"><%=newsinfo.getTopic()%></a></td>
      <td class="td1" align=center><p><a href="editnews.jsp?id=<%=newsinfo.getID()%>">编辑文章</a>&nbsp;&nbsp;<a href="delnews.jsp?id=<%=newsinfo.getID()%>">删除文章</a></p></td>
    </tr>
    <%}%>
  </tbody>
</table>
<TABLE border=0 cellPadding=0 cellSpacing=0 width="100%" align=center>
  <TR>
    <TD align=middle class="td1"><FORM action="main.jsp?page=<%=page1%>&classn=<%="job"%>" method=GET><b>
        <p align='left'>
