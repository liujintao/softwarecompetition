...
<TABLE border="0"  align=center cellpadding=0 cellspacing=1  >
  <!--DWLayoutTable-->
<form method="POST" action="savenews.jsp" onSubmit="return check_input(this)">
    <TR  height=25>
      <TD width="955" height="26" align="center"><FONT ><FONT SIZE="5" COLOR="#449bd1"><b>发布新闻</b></FONT><B><span class="cred">**</span>为必填项目</B></FONT></TD>
    </TR>
    <TR>
      <TD height="558" valign="top"  >&nbsp;<B>文章标题:
        <input  class="input-tit" type="text" name=subject size=70 maxlength=255>
        <textarea  name="Content" rows="30" value="请在此填写新闻的内容" onClick="if (value =='请在此填写新闻的内容'){value =''}" onBlur="if (value ==''){value='请在此填写新闻的内容'}"></textarea>
      </B>
        <div id="apDiv1"> <B>所在版块  ：
          <SELECT style="border:#449bd1 1px solid" NAME="classn">
            <option value="">请选择新闻所在的板块</option>
             <option value="<%="job"%>" selected>就业信息</option>
