...
<%
ContactBean contact=new ContactBean("summer");
...
%>
              <tr>
                ...
                <td><%  jumpPage=pageCtl.curPage+"";
                        out.println("<a href=passsummer.jsp?id="+(Integer)obj[5]+"&pass="+(String)obj[3]+"&jumpPage="+jumpPage+">确认</a >");
                        %>
                </td>
              </tr>
              <%} %>
          ...
          <div class="cont-info-rember">
  <div class="hd">
          <form name="PageForm"  action="summer.jsp" method="post">
           <div style="float:left; width:auto">
            ...
            out.print(" 首页 上一页");
                  ...
                  <A href="summer.jsp?jumpPage=1">首页</A>
                  <A href="summer.jsp?jumpPage=<%=pageCtl.curPage - 1%>">上一页</A>
                  <%}%>

                  <%if (pageCtl.curPage >= pageCtl.maxPage) {
            out.print("下一页 尾页");
        } else {%>
                  <A HREF="summer.jsp?jumpPage=<%=pageCtl.curPage + 1%>">下一页</A>
                  <A HREF="summer.jsp?jumpPage=<%=pageCtl.maxPage%>">尾页</A>
                  <%}%>
