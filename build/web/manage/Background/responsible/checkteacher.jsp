...
<jsp:useBean id="allteacher" scope="page" class="com.ytu.xiao.DatabaseConnection"/>
            ...
            <TBODY>
              <tr>
                ...
                <td>电子邮箱</td>
                  ...
                  <%
                  ContactBean contact=new ContactBean("allteacher");
...
%>
           ...
           <div class="cont-info-rember">
  <div class="hd">
          <form name="PageForm"  action="checkteacher.jsp" method="post">
            ...
            out.print(" 首页 上一页");
                  ...
                  <A href="checkteacher.jsp?jumpPage=1">首页</A>
                  <A href="checkteacher.jsp?jumpPage=<%=pageCtl.curPage - 1%>">上一页</A>
                  <%}%>

                  <%if (pageCtl.curPage >= pageCtl.maxPage) {
            out.print("下一页 尾页");
        } else {%>
                  <A HREF="checkteacher.jsp?jumpPage=<%=pageCtl.curPage + 1%>">下一页</A>
                  <A HREF="checkteacher.jsp?jumpPage=<%=pageCtl.maxPage%>">尾页</A>
                  <%}%>
