...
int ateamid=Integer.parseInt(atitleid);
Class.forName("org.gjt.mm.mysql.Driver");
Connection conn=DriverManager.getConnection("jdbc:mysql://127.0.0.1/web","root","anxin");
Statement stmt=conn.createStatement();
ResultSet rst=stmt.executeQuery(" select * from team where teamid="+ateamid+";");
rst.next();
//String name=rst.getString(2).trim();
String projectname=rst.getString(12).trim();
//String size=rst.getString(3).trim();
int teamid=rst.getInt(1);
String str = (String)request.getRealPath("/")+"teamupload1/"+teamid+"/"+projectname;
//stmt.close();
//con.close();
