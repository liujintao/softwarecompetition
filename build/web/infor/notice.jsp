...
<table width="992" border="0" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
      <TD height="99" width="410" background="images/topback.jpg"><img src="images/logotitle.jpg" /></TD>
      ...
      <TD  background="images/topback.jpg"><UL class=nav>
            ...
            <LI class="navCurrent"><A href="notice.jsp" target="_parent">信息</A> 
            </LI>
...
<map name="Map" id="Map">
  <area shape="rect" coords="62,2,151,38" href="production.html" target="mainFrame"/>
  <area shape="rect" coords="150,3,244,41" href="college.html" target="mainFrame"/>
  <area shape="rect" coords="243,3,333,39" href="matchInfor.html" target="mainFrame" />
  <area shape="rect" coords="333,2,422,38" href="eagle.jsp" target="_parent" />
  <area shape="rect" coords="2,5,60,37" href="notice.jsp" target="_parent"/>
<area shape="rect" coords="422,1,574,37" href="soft.jsp" target="_parent" />
</map>
<div id="main-infor">
  <table width="992px" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="992px" height="auto" bgColor=#ffffff><P class=textnews><SPAN class=textnews_tit><br />公告信息
>></SPAN>
        
        <SPAN   class=STYLE3> 　
        <%	Vector listnews = new Vector();
					DispNews dispnews = new DispNews();
					dispnews.setClassn("notice");
        ...
        <%  for(int j=0;j<listnews.size();j++) {
                    News newsinfo = (News)listnews.elementAt(j);
							if(j>9){continue;}%>
        <A  class=STYLE3 style="text-decoration:underline; font-size:14px" href="../manage/Background/news.jsp?id=<%=newsinfo.getID()%>" target=_blank
							title=<%=newsinfo.getTopic()%>><p>
        ...
        <FONT
            color=#999999><%=newsinfo.getAdddate()%></FONT><p>
        <%}%>
        </P></SPAN>
        </td>
    </tr>
